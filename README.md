...
- `git clone https://github.com/UniversalPropositions/UP_Romanian-Nonstandard.git`
...
- `python3 up2/merge_ud_up.py --input_ud=<ud_path_to_UD_Romanian-Nonstandard>/ --input_up=<up_path_to_UP_Romanian-Nonstandard>/ --output=<path_to_UD+UP_Romanian-Nonstandard>/`
